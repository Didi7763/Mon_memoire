...
<div class="p-8 overflow-y-auto" style="max-height: calc(100vh - 64px);">
    ...
    <div id="main-content" class="relative" style="min-height: 75vh; display: none; opacity: 0;">
        <div class="flex justify-between items-center mb-8 p-4 bg-white rounded-lg shadow-sm min-h-[6rem]">
            ...
            <a href="{{ route('User_Employe.create') }}" class="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3">
                            <div class="flex gap-2">
                                ...
                                <a href="{{ route('User_Employe.edit', $employe->id) }}" class="px-2 py-1 bg-yellow-500 text-white rounded-lg text-xs hover:bg-yellow-600 transition-colors">Modifier</a>
                                <!-- Bouton "Supprimer" plus petit -->
                                <form action="{{ route('User_Employe.destroy', $employe->id) }}" method="POST" onsubmit="return confirm('Confirmer la suppression ?')">
                                    @csrf
                                    @method('DELETE')
