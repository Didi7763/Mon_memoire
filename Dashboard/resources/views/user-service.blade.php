...
<ul>
    ...
    <li class="has-submenu"><a href="#utilisateur" class="active"><i class="bi bi-person"></i>Utilisateur</a>
        <ul class="submenu">
            ...
            <li><a class="dropdown-item active" href="#"><i class="bi bi-gear"></i>Service</a></li>
        </ul>
    </li>
     ...
     <div class="card-form">
        ...
        <div class="head-form">
            <div class="title-form">
                <h2>Formulaire des utilisateurs (services)</h2>
            </div>
            <div class="icon-back">
        ...
        <form action="" method="post" class="content-form">
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" id="CodeUser" placeholder="Code du service" aria-label="Code du service" name="code_user" required="required">
                </div>
                <div class="col">
                    <input type="text" class="form-control" id="NomCompUser" placeholder="Nom du service" aria-label="Nom du service" name="nom_service" required="required">
                </div>
            </div>

            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" id="NpnomRespServ" placeholder="Nom du responsable du service" aria-label="Nom du responsable du service" name="nom_respo_serv">
                </div>
                <div class="col">
                    <input type="email" class="form-control" id="EmailUser" placeholder="L'adresse mail du responsable du service" aria-label="L'adresse mail du responsable du service" name="email_resp_serv">
                </div>
            </div>

            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" id="ContactUser" placeholder="Contact du responsable du service" aria-label="Contact du responsable du service" name="contact_respo_serv">
                </div>
                <div class="col">
                    <textarea  id="DescServ" class="form-control" rows="1" cols="50" placeholder="Description du service (facultatif...)" name="Description_serv"></textarea>
                </div>
            </div>
