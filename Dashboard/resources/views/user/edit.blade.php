        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mt-6 mx-auto w-full max-h-[70vh] overflow-auto">
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="">
                        <label for="NomCompAdmin" class="block text-sm font-medium text-gray-700">Nom complet</label>
                        <input type="text" id="NomCompAdmin" name="NomCompAdmin" value="{{ $user->NomCompAdmin }}" required
                    ...
                    <div class="">
                        ...
                        <div class="mt-2 space-y-2">
                            @foreach (json_decode($user->ListAccApp) as $access)
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="ListAccApp[]" value="{{ $access }}" class="form-checkbox" checked>
                    ...
                    <div class="">
                        ...
                        <div class="mt-2 space-y-2">
                            @foreach (json_decode($user->ListPermApp) as $permission)
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="ListPermApp[]" value="{{ $permission }}" class="form-checkbox" checked>
