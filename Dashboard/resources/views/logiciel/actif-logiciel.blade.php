                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3">
                            <div class="flex gap-2">
                                ...
                                <a href="{{ route('logiciel.edit', $logiciel->id) }}"
                                ...
                                <form action="{{ route('logiciel.destroy', $logiciel->id) }}" method="POST" onsubmit="return checkPermission('delete') && confirm('Confirmer la suppression ?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
